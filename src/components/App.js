...
const App =()=>{
    ...
    let string2=input2;
     ...
     let relation="";
     switch(length){
        case 1: relation="Friends";
        break;
        case 2: relation="Love";
        break;
        case 3: relation="Affection";
        break;
        case 4: relation="Marriage";
        break;
        case 5: relation="Enemy";
        break;
        case 0: relation="Siblings";
        break;
        default:relation="Please Enter valid input";
        break;
     }
  setResult(relation);
    }
